        ...
        <div className="flex justify-start items-center overflow-x-auto gap-2 pb-4 snap-x snap-mandatory scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
          {subcategories.map((subcategory, index) => (
            <button
              ...
              className={`flex-shrink-0 snap-start w-[150px] h-[50px] rounded-full font-semibold text-sm flex items-center justify-center shadow-md ${selectedSubcategory === subcategory
