      ...
      const fetchAllRecipes = async () => {
        try {
          ...
          const filteredContentfulRecipes = contentfulRecipes.filter((item) => {
            return Array.isArray(item.fields.kategorija) && item.fields.kategorija.some((kat) => kat === 'Prema vrsti obroka') &&
          ...
          if (localStorageRecipes) {
            try {
              ...
              const filteredLocalStorageRecipes = formattedRecipes.filter((recipe: any) => {
                return recipe.fields.kategorija.includes('Prema vrsti obroka') &&
