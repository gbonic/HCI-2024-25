...
const PremaVrstiObrokaPage = () => {
    ...
    const fetchAllData = async () => {
      ...
      try {
        ...
        const zdravSubcategories = podkategorijeResponse.items
          .filter((podkat: any) => podkat.fields.kategorija?.fields.nazivKategorije === "Prema vrsti obroka")
  ...
  return (
    <main className="grid grid-rows-[auto_auto_auto] min-h-screen text-[#2E6431] justify-center">
      ...
      <section className="lg:hidden w-full max-w-[90vw] mx-auto overflow-hidden px-4">
        <div className="flex justify-center items-center overflow-x-auto gap-2 pb-4 snap-x snap-mandatory scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
